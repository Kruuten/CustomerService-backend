...
class UpdateCustomerAddressComponent extends Component {
    ...
    componentDidMount(){
        CustomerService.getCustomerById(this.state.id).then((res) => {
            ...
            this.setState({
                registredAddress:{
                    registredCountry: customer.registredCountry,
                    registredRegion: customer.region,
                    registredCity:customer.city,
                    registredStreet: customer.street,
                    registredHouse: customer.house,
                    registredFlat: customer.flat,
                    },
                actualAddress:{
                    actualCountry: customer.country,
                    actualRegion: customer.region,
                    actualCity:customer.city,
                    actualStreet: customer.street,
                    actualHouse: customer.house,
                    actualFlat: customer.flat,
                    },
